...
Constraints = [IC1, IC2, IC3, IC4, IC5, IC6, IC7, IC8, IC9, IC10, IC11, IC12, IC13, IC14, IC15, IC16, IC17, IC18, IC19,
               IC20, IC21]
...
def main():
    validate("Care_Providers.ttl")
    validate("Population_2021.ttl")
